...
class OngoingOrdersViewController: UIViewController , UITableViewDataSource, UITableViewDelegate {
     ...
     //Mark Variables
        ...
        override func viewWillAppear(_ animated: Bool) {
            setBackWithTitle(titleVal: "Ongoing Orders")
            self.offset = 0
    ...
    extension OngoingOrdersViewController {
        
        func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
            return viewModel.getOrderManageData()?.count ?? 0
        }
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! OngoingOrdersTableViewCell
            ...
            cell.imageViewOrders.layer.cornerRadius = 15
...
extension OngoingOrdersViewController {
    func hitApiOrderList(){
        ...
        viewModel.apiOrderList(Status: "ongoing" ,Limit: "10", Offset: String(self.offset)){(isSuccess , message) in
