...
class NewOrdersViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
 ...
 //Mark Variables
    ...
    override func viewWillAppear(_ animated: Bool) {
        setBackWithTitle(titleVal: "New Orders")
        self.offset = 0
...
extension NewOrdersViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! NewOrdersTableViewCell
...
func hitApiOrderList(){
    ...
    viewModel.apiOrderList(Status: "pending" , Limit: "10", Offset: String(self.offset)){(isSuccess , message) in
