//
//  QuotationInProgressViewController.swift
//  Dreesha User
//
...
class QuotationInProgressViewController: UIViewController {
...
extension QuotationInProgressViewController: UITableViewDelegate,UITableViewDataSource{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! QuotationInProgressTableViewCell
    ...
    //MARK:- API Call
extension QuotationInProgressViewController{
    func hitApiQuotationsList(Search: String , Filter : String){
        
        Indicator.shared.showProgressView(self.parent?.view ?? self.view)
        
        viewModel.apiQuotationListfunc(limit: "10", offset: String(self.offset) , Status: "inprogress" ,Search: Search ,Filter: Filter ){(isSuccess , message) in
