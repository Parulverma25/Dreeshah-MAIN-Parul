//
//  QuotationReqClosedViewController.swift
//  Dreesha User
//
...
class QuotationReqClosedViewController: UIViewController {
...
extension QuotationReqClosedViewController: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! QuotationReqClosedTableViewCell
...
//MARK:- API Call
extension QuotationReqClosedViewController{
    func hitApiQuotationsList(Search: String , Filter : String){
        
        Indicator.shared.showProgressView(self.parent?.view ?? self.view)
        
        viewModel.apiQuotationListfunc(limit: "10", offset: String(self.offset) , Status: "closed" ,Search: Search ,Filter: Filter ){(isSuccess , message) in
